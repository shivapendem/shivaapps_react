...
const FeaturesSplit = ({
  ...
  const sectionHeader = {
    title: 'Portfolio',
    paragraph: 'From Web Components and UI/UX animations to React.JS, Redux, Vue.JS, and Node.JS. Check out my latest web software development portfolio projects.'
  };
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                  ...
                  <br/>
                  <a href="https://shivapendem.medium.com/" target="_blank"  rel="noopener noreferrer"> view</a>
              </div>
              <div className={
                classNames(
