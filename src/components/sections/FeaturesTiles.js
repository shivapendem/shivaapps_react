...
const FeaturesTiles = ({
  ...
  const sectionHeader = {
    title: 'My key notes for your projects',
    paragraph: 'Key factors which made me to be the best in industry in my experence.'
  };
            ...
            <div className="tiles-item reveal-from-bottom" data-reveal-delay="400">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
                    Strong preference for easy to use, with standards in the market.
                    </p>
                </div>
              </div>
            </div>
